 ...
 *
 * <script src="https://YOUR_DOMAIN/widget.js" data-host="https://YOUR_DOMAIN" data-product="promptgen-pro" async></script>
 *
...
(function () {
  ...
  host = host.replace(/\/+$/, "");
  var product = (tag && tag.getAttribute("data-product")) || "promptgen-pro";
  ...
  function build() {
    ...
    var panel = null;
    var sessionKey = (product || "promptgen-pro") + "_chat_session";
