  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://promptgen-pro.lxsaihub.com/" />
      
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "What is PromptGen Pro?", "acceptedAnswer": {"@type": "Answer", "text": "PromptGen Pro generates production-ready AI prompts with variables, examples, and guardrails."}}, {"@type": "Question", "name": "What do I describe?", "acceptedAnswer": {"@type": "Answer", "text": "The task you want the model to perform."}}, {"@type": "Question", "name": "Which models does it target?", "acceptedAnswer": {"@type": "Answer", "text": "Prompts suitable for ChatGPT, Claude, and API-style calls."}}, {"@type": "Question", "name": "Does it include variables?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. Variable placeholders make prompts reusable."}}, {"@type": "Question", "name": "Who should use it?", "acceptedAnswer": {"@type": "Answer", "text": "Teams that want structured prompts instead of ad-hoc chat paste."}}, {"@type": "Question", "name": "Does it replace evaluation?", "acceptedAnswer": {"@type": "Answer", "text": "No. It drafts prompts; you still judge outputs for your use case."}}]}` }} />
        </Head>
      ...
      <div className="min-h-screen bg-white text-slate-900">
        ...
        <section id="definition" className="py-20 bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold mb-4">PromptGen Pro - definition</h2>
