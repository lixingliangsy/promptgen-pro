...
const howToSteps = [
  { name: 'Describe the task', text: 'State what you want the model to do and any constraints.' },
  { name: 'Generate the prompt', text: 'Get a structured prompt with variables, examples, and guardrails.' },
  { name: 'Copy or export', text: 'Paste into ChatGPT, Claude, or your API workflow and evaluate outputs.' },
]
...
export default function Page() {
  ...
  const SHORT = "PromptGen Pro turns a task description into production-ready AI prompts with variables, examples, and guardrails…"
  return (
    <>
      <Head>
      ...
      <div className="min-h-screen bg-slate-50 text-slate-800">
        ...
        <main className="max-w-3xl mx-auto px-6 py-14">
          ...
          <p className="mt-3 text-lg font-semibold text-slate-900" data-geo-short-lead="1">PromptGen Pro turns a task description into production-ready AI prompts with variables, examples, and guardrails…</p>
