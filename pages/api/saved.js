...
let savedPrompts = [
  ...
  {
    id: 'saved_002',
    name: 'Python data-analysis code',
    prompt: 'Write Python code to analyse the sales data in a CSV file. Requirements:\n1. Read the data with pandas\n2. Compute basic summary statistics\n3. Produce charts\n4. Include detailed code comments\n5. Handle the exceptions that can occur',
    category: 'programming',
    tags: ['Python', 'data analysis', 'visualisation'],
    isPublic: true,
    usageCount: 12,
    rating: 4.8,
