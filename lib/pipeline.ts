...
export const PIPELINE_ID = 'promptgen-pro-v1'
export const STEP_ORDER: StepId[] = ['input', 'process', 'output']
export const STEP_LABELS: Record<StepId, string> = {
  input: "Step 1/3 · Describe the task",
  process: "Step 2/3 · Structure prompt + variables",
  output: "Step 3/3 · Guardrails + copy/export",
}
